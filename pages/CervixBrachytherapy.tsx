        ...
        {!isSidebarOpen && (
          <motion.button 
            ...
            style={{
              ...
              backgroundColor: COL.card, color: COL.text, padding: "12px",
              borderRadius: "12px 0 0 12px", border: `1px solid ${COL.roseBd}`,
              borderRight: "none", boxShadow: "-4px 0 16px rgba(0,0,0,0.3)",
              display: "flex", flexDirection: "column", alignItems: "center", gap: "12px",
              cursor: "pointer", transition: "all 0.2s"
            }}
            onMouseEnter={e => e.currentTarget.style.backgroundColor = `${COL.rose}22`}
            onMouseLeave={e => e.currentTarget.style.backgroundColor = COL.card}
          >
            <BookOpen size={20} color={COL.rose} />
            <span style={{
